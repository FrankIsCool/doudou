...
public enum  ExceptionCode {
    ...
    //用户-登陆异常
    ERRO_102001("102001","登录失败！信息已反馈平台。"),
    ERRO_102002("102002","登录失败！账号不存在。"),
    ERRO_102003("102003","登录失败！账号异常，请联系管理员。"),
    ERRO_102004("102004","登录失败！密码错误。"),
    ERRO_102005("102005","登录失败！账户已被冻结。"),

    //用户-资金
    ERRO_103000("103000","资金异常！已联系管理员。"),
    ERRO_103001("103001","资金已被冻结！如有需要请联系管理员。"),

    //用户-信息
    ERRO_104000("104000","用户信息错误！用户名不存在。"),
    ;
